...
public class RenderCrossbowBolt extends Render {
    public void renderBolt(EntityCrossbowBolt entitybolt, double par2, double par4, double par6, float par8, float par9) {
        ...
        GL11.glRotatef(entitybolt.prevRotationYaw + (entitybolt.rotationYaw - entitybolt.prevRotationYaw) * par9
                - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(entitybolt.prevRotationPitch + (entitybolt.rotationPitch - entitybolt.prevRotationPitch) * par9,
                0.0F, 0.0F, 1.0F);
