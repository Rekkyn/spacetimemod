...
public class SpacetimeAccessTransformer extends AccessTransformer {
    private static SpacetimeAccessTransformer instance;
    private static List mapFiles = new LinkedList();
    
    public SpacetimeAccessTransformer() throws IOException {
        super();
        instance = this;
        // add your access transformers here!
        mapFiles.add("spacetime_at.cfg");
    ...
    private void readMapFile(String name) {
        System.out.println("[Spacetime]: Adding transformer map: " + name);
        try {
